...
if __name__ == "__main__":
    ...
    draft = LlamaForCausalLM.from_pretrained("NousResearch/Hermes-3-Llama-3.2-1B", torch_dtype=torch.float16, device_map="cuda:0")
    draft = draft.eval()
    
    model = AutoModelForCausalLM.from_pretrained("NousResearch/Hermes-3-Llama-3.2-1B")
